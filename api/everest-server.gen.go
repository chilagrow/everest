...
type ServerInterface interface {
	...
	// (GET /clusters/{cluster}/namespaces/{namespace}/data-stores/{dataStore}/extensions/{extensionType})
	ListDataStoreExtensions(ctx echo.Context, cluster string, namespace string, dataStore string, extensionType string) error
	// Create data store extension
	// (POST /clusters/{cluster}/namespaces/{namespace}/data-stores/{dataStore}/extensions/{extensionType})
	CreateDataStoreExtension(ctx echo.Context, cluster string, namespace string, dataStore string, extensionType string) error
	// Delete data store extension
	// (DELETE /clusters/{cluster}/namespaces/{namespace}/data-stores/{dataStore}/extensions/{extensionType}/{extension})
	DeleteDataStoreExtension(ctx echo.Context, cluster string, namespace string, dataStore string, extensionType string, extension string) error
	// Get data store extension
	// (GET /clusters/{cluster}/namespaces/{namespace}/data-stores/{dataStore}/extensions/{extensionType}/{extension})
	GetDataStoreExtension(ctx echo.Context, cluster string, namespace string, dataStore string, extensionType string, extension string) error
	// Update data store extension
	// (PUT /clusters/{cluster}/namespaces/{namespace}/data-stores/{dataStore}/extensions/{extensionType}/{extension})
	UpdateDataStoreExtension(ctx echo.Context, cluster string, namespace string, dataStore string, extensionType string, extension string) error
...
func (w *ServerInterfaceWrapper) ListDataStoreExtensions(ctx echo.Context) error {
	...
	// ------------- Path parameter "extensionType" -------------
	var extensionType string

	err = runtime.BindStyledParameterWithOptions("simple", "extensionType", ctx.Param("extensionType"), &extensionType, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter extensionType: %s", err))
	}

	ctx.Set(BearerAuthScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.ListDataStoreExtensions(ctx, cluster, namespace, dataStore, extensionType)
	return err
}
...
func (w *ServerInterfaceWrapper) CreateDataStoreExtension(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.CreateDataStoreExtension(ctx, cluster, namespace, dataStore, extensionType)
	return err
}
...
func (w *ServerInterfaceWrapper) DeleteDataStoreExtension(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.DeleteDataStoreExtension(ctx, cluster, namespace, dataStore, extensionType, extension)
	return err
}
...
func (w *ServerInterfaceWrapper) GetDataStoreExtension(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetDataStoreExtension(ctx, cluster, namespace, dataStore, extensionType, extension)
	return err
}
...
func (w *ServerInterfaceWrapper) UpdateDataStoreExtension(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.UpdateDataStoreExtension(ctx, cluster, namespace, dataStore, extensionType, extension)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/clusters/:cluster/namespaces/:namespace/data-stores/:dataStore/extensions/:extensionType", wrapper.ListDataStoreExtensions)
	router.POST(baseURL+"/clusters/:cluster/namespaces/:namespace/data-stores/:dataStore/extensions/:extensionType", wrapper.CreateDataStoreExtension)
	router.DELETE(baseURL+"/clusters/:cluster/namespaces/:namespace/data-stores/:dataStore/extensions/:extensionType/:extension", wrapper.DeleteDataStoreExtension)
	router.GET(baseURL+"/clusters/:cluster/namespaces/:namespace/data-stores/:dataStore/extensions/:extensionType/:extension", wrapper.GetDataStoreExtension)
	router.PUT(baseURL+"/clusters/:cluster/namespaces/:namespace/data-stores/:dataStore/extensions/:extensionType/:extension", wrapper.UpdateDataStoreExtension)
